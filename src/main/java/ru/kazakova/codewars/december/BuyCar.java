...
public class BuyCar {
     ...
     * one decrease of 1.5 percent per month.
    ...
    // каждый месяц откладывает по 1000
    // стоимость машин падает на  1.5% + 0.5 каждый второй месяц
    // сколько нужно месяцев, чтобы купить и какая сумма останется в +
    // если стоимость старого >= нового - не нужно экономить
