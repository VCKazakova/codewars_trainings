...
public class InterestingTrip {
     ...
     * Хорошо всем известный программист Петя тоже очень любит путешествовать, посещать музеи и осматривать
     * достопримечательности других городов.
     ...
     * ). В следующих
     * n
     *  строках даны два целых числа: координаты каждого города, не превосходящие по модулю миллиарда.
     *  Все города пронумерованы числами от 1 до
     * n
     *  в порядке записи во входных данных.
     * В следующей строке записано целое положительное число
     * k
     * , не превосходящее двух миллиардов, — максимальное расстояние между городами, которое
     * Петя может преодолеть без дозаправки машины.
